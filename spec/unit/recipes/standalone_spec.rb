...
describe 'jnj_chef_stack::standalone' do
  context 'When all attributes are default, on an unspecified platform' do
    ...
    before do
      ...
      allow_any_instance_of(Chef::Recipe).to receive(:read_env_secret).with('standalone_secrets')\
        .and_return(parse_data_bag('chef_stack/infra_secrets.json')['_default']['standalone_secrets'])
